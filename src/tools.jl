...
function compile_W_terms(C::Nemo.Generic.MPoly{Nemo.ComplexFieldElem})
    n_vars = nvars(parent(C))
...
export sweep, wick_out, W, compile_W_terms, W_fast, permutation_matrix, reorder, k_function_matrix
